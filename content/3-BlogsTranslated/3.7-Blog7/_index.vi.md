---
title: "Zeta Global mở rộng việc thu thập dữ liệu đa khách hàng với Amazon S3 Tables"
date: "2025-09-22"
weight: 7
chapter: false
pre: " <b> 3.7. </b> "
...
# Zeta Global mở rộng việc thu thập dữ liệu đa khách hàng với Amazon S3 Tables

*bởi Soumil Shah, Varad Ram, Ananth Packkildurai, và Manoj Agarwal | ngày 22 tháng 9 năm 2025 | in Amazon Athena, Amazon EMR, Amazon S3 Tables, Amazon Simple Storage Service (S3), Customer Solutions, Intermediate (200)*
...
Zeta sử dụng S3 Tables làm nền tảng cho hồ dữ liệu lakehouse. S3 Tables được thiết kế để tương thích với nhiều khung xử lý và công cụ truy vấn khác nhau, hỗ trợ cả pipeline xử lý hàng loạt (batch) và luồng dữ liệu (streaming).
...
Zeta áp dụng mô hình "khóa trước, xử lý sau" (lock-first, process-later) tránh các điều kiện tranh chấp (race conditions) và trùng lặp ghi:
...
Zeta Global đã dùng S3 Tables để đạt được khả năng mở rộng đặc biệt với hơn 4.000 bảng quản lý đa khách hàng, tính toàn vẹn dữ liệu với cam kết nhất quán khi xử lý song song, và hiệu quả vận hành xử lý hàng chục terabyte mỗi ngày với tối ưu tài nguyên. Nền tảng hỗ trợ linh hoạt với nhiều công cụ truy vấn đa dạng và khả năng phục hồi tự động qua cơ chế phục hồi lỗi.

S3 Tables còn tăng cường các lợi ích này qua việc:
- Tối ưu file tự động, hợp nhất các đối tượng dữ liệu nhỏ thành các file lớn 512 MB giúp cải thiện hiệu năng truy vấn
- Quản lý snapshot tự động giữ và xóa các snapshot bảng theo thời gian
- Xóa các file không còn dùng (orphaned files) để tối ưu lưu trữ
...
**Soumil Shah** - Kỹ sư cấp cao (Sr Software Engineer - Big Data) tại Zeta Global, chuyên xây dựng các giải pháp kỹ thuật dữ liệu có khả năng mở rộng.

**Varad Ram** - Kiến trúc sư giải pháp doanh nghiệp hỗ trợ mảng quảng cáo và tiếp thị tại AWS.

**Ananth Packkildurai** - Kỹ sư chính tại Zeta, lãnh đạo kiến trúc nền tảng dữ liệu đa khách hàng mở rộng.

**Manoj Agarwal** - Kiến trúc sư chính tại Zeta Global, dẫn dắt thiết kế các nền tảng AI và dữ liệu quy mô lớn hỗ trợ giải pháp marketing và quảng cáo thời gian thực.